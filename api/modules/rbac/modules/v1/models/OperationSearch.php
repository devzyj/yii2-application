 ...
 * @since 1.0
 */
class OperationSearch extends Operation implements SearchModelInterface
{
    ...
    public function searchRelationAttributeMap()
    {
        return ArrayHelper::merge(
            ...
            $this->permissionsAttributeFieldMap(),
    ...
    /**
     * 关联模型 [[Permission]] 属性与字段的映射。
     * 
     * @return array
     */
    public function permissionsAttributeFieldMap()
    {
        /* @var $model PermissionSearch */
        $model = PermissionSearch::instance();
        $prefix = self::EXTRA_FIELDS_PERMISSIONS . '_';
        $attributeMap = $model->searchAttributeFieldMap($prefix);
