...
class AssignAction extends \devzyj\rest\Action
{
     ...
     * @return ActiveRecordInterface 成功分配的关联模型。
     */
     ...
     * @throws NotFoundHttpException 关联模型不存在。
     * @throws ForbiddenHttpException 模型与关联模型中的 `client_id` 不同，或者已经分配过。
     */
     ...
     * @param ActiveRecordInterface $relation
     * @return ActiveRecordInterface 分配成功的关联模型。
     */
