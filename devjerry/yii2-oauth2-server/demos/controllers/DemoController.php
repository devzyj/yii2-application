 ...
 */
namespace devjerry\yii2\oauth2\server\demos\controllers;

use Yii;
use yii\widgets\ActiveForm;
use yii\web\Response;
use yii\helpers\Url;
use devjerry\yii2\oauth2\server\demos\models\DemoLoginForm;
use devjerry\yii2\oauth2\server\demos\models\DemoAuthorizationForm;
...
{
    /**
     * @var \devjerry\yii2\oauth2\server\Module
     */
    public $module;
